...
- (void)deleteClick
{
    [CHNotificationCenter postNotificationName:HWEmotionDidDeleteNotification object:nil];
}
...
- (void)selectEmotion:(HWEmotion *)emotion
{
    ...
    [CHNotificationCenter postNotificationName:HWEmotionDidSelectNotification object:nil userInfo:userInfo];
}
@end
