...
#import "OAuthAccountModel.h"

@implementation OAuthAccountModel
+ (instancetype)OAuthAccountWithDict:(NSDictionary *)dict
{
    OAuthAccountModel *account = [[self alloc] init];
...
- (void)encodeWithCoder:(NSCoder *)encoder
{
    ...
    [encoder encodeObject:self.OAuth_name forKey:@"OAuth_name"];
}
...
- (id)initWithCoder:(NSCoder *)decoder
{
    if (self = [super init]) {
        ...
        self.OAuth_name = [decoder decodeObjectForKey:@"OAuth_name"];
    }
    return self;
}
